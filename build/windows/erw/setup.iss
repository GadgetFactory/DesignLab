...
DefaultDirName={sd}\DesignLab-1.0.4
...
[Icons]
Name: "{group}\DesignLab 1.0.4"; Filename: {app}\DesignLab.exe; 
Name: "{group}\Install Papilio Drivers"; Filename: {app}\drivers\install.bat; Flags: excludefromshowinnewinstall; 
Name: "{userdesktop}\DesignLab 1.0.4"; Filename: {app}\DesignLab.exe; Tasks: desktopicon; 
